  ...
  return (
    <NoteGuideShell>
      ...
      <div className="card">
        ...
        <GuideSection title="(a) ノートのID（アカウント）の差し替え" level={2} open={true}>
          <p>
        ...
        <GuideSection title="(b) パスワード／アクセス権限の正体" level={2}>
          <div className="callout note">
        ...
        <GuideSection title="投稿の流れ" level={2}>
        ...
        <GuideSection title="サムネイルは手動アップロード" level={2}>
          <p>
        ...
        <GuideSection title="注意点" level={2}>
          <ul>
